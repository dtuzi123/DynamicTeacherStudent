...
class LifeLone_MNIST(object):
    ...
    def Build_NewExerpt(self):
        ...
        gan_code = self.z
        G1 = Generator_Celeba(generatorStr, gan_code, reuse=False)
        self.GenerationArr.append(G1)
    ...
    def build_model(self):
        ...
        self.DLossArr.append(self.d_loss1)
        self.GLossArr.append(self.g_loss1)
        ...
        beta = 0.0001
        vaeloss1 = reconstruction_loss1 + beta*KL_divergence1
    ...
    def test(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            self.saver.restore(sess, 'models/LifelongMixtureGAN_Unsupervised_64_1')

            batch_z = np.random.uniform(-1, 1, [self.batch_size, self.z_dim]).astype(np.float32)

            g1,g2,g3,g4 = sess.run([self.GAN_gen1,self.GAN_gen2,self.GAN_gen3,self.GAN_gen4],feed_dict={self.z:batch_z})
            ims("results/" + "SingleGANs_CelebaToCACD" + str(0) + ".png", merge2(g1[:64], [8, 8]))
            ...
            batchFiles = x_train[0:batch_size]
            ...
            ims("results/" + "Celeba" + str(0) + ".jpg", merge2(myReco[:64], [8, 8]))
    ...
    def train(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            for taskIndex in range(taskCount):
                ...
                for epoch in range(start_epoch, self.epoch):
                    ...
                    for i in range(total_batch*k1):
                        ...
                        if taskIndex != 0:
                            ...
                            for myIndex in range(np.shape(self.GenerationArr)[0]):
                                myGAN = self.GenerationArr[myIndex]
                                gan1 = self.sess.run(
                                    myGAN,
                ...
                self.saver.save(self.sess, "models/LifelongMixtureGAN_Unsupervised_64_1")
